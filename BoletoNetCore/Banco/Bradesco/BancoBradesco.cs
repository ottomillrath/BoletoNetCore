...
namespace BoletoNetCore
{
    internal sealed partial class BancoBradesco : BancoFebraban<BancoBradesco> , IBanco
    {
        ...
        public void FormataBeneficiario()
        {
            ...
            contaBancaria.FormatarDados("PAG�VEL PREFERENCIALMENTE NA REDE BRADESCO OU BRADESCO EXPRESSO.", contaBancaria.MensagemFixaTopoBoleto, contaBancaria.MensagemFixaPagador, 7);
