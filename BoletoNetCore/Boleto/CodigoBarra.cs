...
namespace BoletoNetCore
{
    public class CodigoBarra
    {
        ...
        public string DigitoVerificador
        {
            get
            {
                Console.WriteLine("CodigoBarra.cs: Calculando dígito verificador");
                // C�lculo do D�gito Verificador do C�digo de Barras
                ...
                string codigoSemDv = string.Format("{0}{1}{2}{3}{4}",
                                      ...
                                      ValorDocumento,
                                      CampoLivre);
                Console.WriteLine(string.Format("CodigoBanco: {0}, Moeda: {1}, FatorVencimento: {2}, ValorDocumento: {3}, CampoLivre: {4}, CodigoSemDv: {5}", CodigoBanco, Moeda, FatorVencimento, ValorDocumento, CampoLivre, codigoSemDv));
