...
namespace BoletoNetCore.Exceptions
{
    public sealed class BoletoNetCoreException : Exception
    {
        ...
        public static BoletoNetCoreException ErroAoRegistrarTituloOnline(string mensagem, Exception ex = null)
            => new BoletoNetCoreException($"Erro ao Registrar Titulo Online: {mensagem}", ex);
